...
annotations_ob = load_data("in/oblivion/extracted_data_oblivion.csv", "in/oblivion/voice/");
samplerate_ob = 44100;
write_counts_table(annotations_ob.EmotionType, "out/category_counts_oblivion.csv");

annotations_nv = load_data("in/newvegas/extracted_data_new_vegas.csv", "in/newvegas/voice/");
samplerate_nv = 22050;
